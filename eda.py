...
def eda(sentence, alpha_sr=0.1, alpha_ri=0.1, alpha_rs=0.1, p_rd=0.1, num_aug=9 , reverse = False):
...
def gen_eda(df , output_file, alpha, num_aug=1, reverse = False):
    ...
    for i in range(len(label)):
        ...
        label = y[i]
        sentence = x[i]
        aug_sentences = eda(sentence, alpha_sr=alpha, alpha_ri=alpha, alpha_rs=alpha, p_rd=alpha, num_aug=num_aug, reverse = reverse)
